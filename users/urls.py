...
from .views import VerifyResetCodeView, PasswordChangeView, confirm_password, change_password, clear_profile_picture
...
urlpatterns = [
    ...
    path("clear-picture/",  clear_profile_picture, name="clear-picture"), 
]
